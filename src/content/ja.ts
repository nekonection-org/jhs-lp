...
export const ja = {
  ...
  server: {
    ...
    settingsTitle: "設定",
    settingsDescription:
      "サーバー設定と運用時刻を項目ごとにご案内します。適用条件と例外は、このページのサーバールール全文をご確認ください。",
  ...
  rules: {
    ...
    title: "重要なルール",
    description:
      "参加者が安心して遊べるよう、特に重要な項目を簡潔にご案内します。サーバールールの全文もこのWebサイトで確認できます。",
    ...
    items: [
      {
        ...
        title: "レイド可能時間",
        description:
          "平日18:00〜24:00、土・日12:00〜24:00のみレイド可能です。時間外に他プレイヤーの建築物へ攻撃した場合は段階的に処分し、実際に破壊した場合は次回ワイプまで自動BANします。対象外となる行為はルール全文をご確認ください。",
        icon: "clock",
        status: "confirmed",
        important: true,
      },
      ...
      },
      {
        ...
        title: "不正行為への対応",
        description:
          "チート、グリッチ、不正ツールなど、公式サーバーで禁止されている行為は永久BAN対象です。異議申し立てはDiscordの#claim-ticketで受け付け、Admin / ModeratorへのDMでは対応しません。",
        icon: "shield",
        status: "confirmed",
      },
      {
    ...
    rulebook: {
      title: "Japan Hideaway Server サーバールール",
      openLabel: "サーバールール全文を見る",
      closeLabel: "サーバールール全文を閉じる",
      blocks: [
        {
          id: "raid-rules",
          title: "レイド可能時間と時間外レイド",
          paragraphs: [
            "「時間外レイド」とは、レイド可能時間外に他プレイヤーの建築物を攻撃または破壊する行為です。時刻はすべて日本時間（JST）です。",
          ],
          items: [
            {
              id: "weekdays",
            ...
            },
            {
              ...
              label: "時間外レイドの対象",
              description:
                "他プレイヤーの建築物（壁・ドア・ボート建築など）への攻撃・破壊",
            },
            {
              id: "exemptions",
              label: "時間外レイドの対象外",
              description:
                "野外設置物（ターレットなど）の破壊、パスコードレイド、藁・木強化建築、自拠点および周辺TC柱の破壊",
            },
            {
              id: "attack-enforcement",
              label: "建築物を破壊していない違反",
              description:
                "1回目は警告、2回目はサーバーキック、キック後に再度違反した場合は違反者とチーム全員を次回ワイプまでBAN",
            },
            {
              id: "destruction-enforcement",
              label: "建築物を破壊した場合",
              description:
                "違反回数にかかわらず、自動的に次回ワイプまでBAN。ログ確認後、違反者の拠点を破壊します",
            },
            {
              id: "accident",
              label: "誤って破壊した場合",
              description: "速やかに運営へ報告してください",
            },
          ],
        },
        {
          id: "cheating",
          title: "1. チート・グリッチ・不正ツールの使用",
          penalty: "永久BAN",
          paragraphs: [
            "公式サーバーで禁止されている行為全般を禁止します。検知や調査の状況により、自動的または一時的にサーバーからキック・BANする場合があります。",
          ],
          items: [
            {
              id: "party-member",
              label: "同一パーティでプレイしていた場合",
              description: "初回は30日BAN、2回目以降は永久BAN",
            },
            {
              id: "appeal",
              label: "異議申し立て",
        ...
        {
          id: "conduct",
          title: "2. 暴言・差別発言・過度な煽り・誹謗中傷",
          penalty: "警告〜永久BAN",
          paragraphs: [
            "政治的・差別的な発言、執拗な個人攻撃など、社会通念上許容される範囲を超えた不適切な言動を禁止します。",
          ],
          items: [
            {
              id: "locations",
              description:
                "ゲーム内チャット、VC、自動販売機、建築物、看板、拠点およびDiscordサーバー内のチャンネルが対象です。",
            },
            {
              id: "removal",
              description:
                "問題のある建築物、看板、自動販売機、拠点などは撤去します。",
            },
            {
              id: "serious",
              description:
                "悪質性が高い場合は、事前警告なく有期BANまたは永久BANとすることがあります。",
            },
          ],
        },
        {
          id: "teaming",
          title: "3. チーム人数制限違反（チーミング）",
          penalty: "警告〜永久BAN",
          paragraphs: [
            "チーム人数は最大4人です。チーム外プレイヤーとの物資共有、共闘、拠点共有を禁止します。",
          ],
          items: [
            {
              id: "retirement",
              label: "引退時の物資譲渡",
              description:
                "譲渡自体は容認しますが、譲渡後は寝袋・TCなどの権限を解除し、速やかにログアウトして当該ワイプ中のプレイを控えてください。",
            },
          ],
        },
        {
          id: "feedback",
          title: "サーバーへの意見・批判について",
          paragraphs: [
            "サーバーや運営に関する意見や批判そのものは禁止していません。",
            "ただし、意見や批判を理由として、暴言、差別、誹謗中傷、執拗な個人攻撃など、社会通念上許容される範囲を超えた不適切な行為を行うことは禁止します。",
          ],
        },
        {
          id: "operations",
          title: "運営方針・報告方法",
          paragraphs: [
            "基本的にプレイスタイルは制限しませんが、本ルールで禁止する不適切な行為はプレイスタイルとは認めません。警告を無視する場合や悪質なケースはBAN処置の対象です。",
          ],
          items: [
            {
              id: "fairness",
              description:
                "運営は、すべてのプレイヤーに対して可能な限り公平に対応します。",
            },
            {
              id: "cheat-report",
              description:
                "チート、グリッチ、不正ツールの使用が疑われる場合はRust内のF7レポートを利用し、録画などの証拠は必要に応じてDiscordのチケットから運営へ報告してください。",
            },
            {
              id: "other-report",
              description:
                "その他のルール違反もDiscordのチケット機能から報告してください。",
            },
            {
              id: "changes",
              description:
                "健全な運営のため、ルールは予告なく変更される場合があります。",
            },
            {
              id: "volunteer",
              description:
                "運営は有志のボランティアとして時間や費用を負担しながら管理しています。サーバー環境やチーター対応は可能な限り改善しますが、常に完全な環境や即時対応を保証するものではありません。",
            },
            {
              id: "choice",
              description:
                "サーバーの方針や環境が合わない場合は、他のサーバーの利用もご検討ください。",
            },
          ],
        },
      ],
      supplementaryNote:
        "このWebサイトに掲載する内容を最新のサーバールールとして扱います。利用規約と最新のお知らせもあわせてご確認ください。",
      lastUpdatedLabel: "最終更新日",
      lastUpdated: "2026年8月25日",
    },
  },
  vip: {
    id: "vip",
  ...
  terms: {
    ...
    articles: [
      {
        ...
        paragraphs: [
          ...
          "公式Webサイトに掲載するサーバールール、告知および運営上の案内も、本規約の一部を構成します。Discordでは更新のお知らせやサポート案内を行う場合がありますが、サーバールールは公式Webサイトの最新版を正とします。",
        ],
      },
      {
        id: "environment",
      ...
      },
      {
        ...
        title: "第9条（規約の変更）",
        paragraphs: [
          "運営は、必要に応じて本規約を変更または追記できます。変更内容と適用時期は公式Webサイトで公開し、必要に応じて関連Discordコミュニティでも更新をお知らせします。",
    ...
    supplementaryNote:
      "本規約とあわせて、このWebサイトに掲載する最新のサーバールール・告知をご確認ください。Discordは問い合わせと更新通知の補助的な窓口として利用します。",
    lastUpdatedLabel: "最終更新日",
    lastUpdated: "2026年8月25日",
  },
  footer: {
